...
class TCN_GCN_unit(nn.Module):
    def __init__(self, in_channels, out_channels, A, stride=1, residual=True, adaptive=True, kernel_size=17, dilations=[1,2,3,4,5,6,7,8]):
...
class Model(nn.Module):
    def __init__(self, num_class=11, num_point=15,  graph=None, in_channels=3, adaptive=True, num_channel = 64):
        ...
        self.l1 = TCN_GCN_unit(num_channel, base_channel, A, residual=False, adaptive=adaptive)
...
if __name__ == '__main__':
    ...
    M=Model(graph=A, in_channels=2, num_point=15).cuda()
    out=M(x)
    print(out.shape)
